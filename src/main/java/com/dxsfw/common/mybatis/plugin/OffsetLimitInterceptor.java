package com.dxsfw.common.mybatis.plugin;
...
import com.dxsfw.common.mybatis.dialect.Dialect;
import com.dxsfw.common.util.PropertiesHelper;
...
public class OffsetLimitInterceptor implements Interceptor {
	...
	void processIntercept(final Object[] queryArgs) {
		...
		if (dialect.supportsLimit() && (offset != RowBounds.NO_ROW_OFFSET || limit != RowBounds.NO_ROW_LIMIT)) {
			...
			// --------------------------------------------------------------------------
			// Added by leo on 2013-5-14. https://code.google.com/p/rapid-framework/issues/detail?id=63
			// --------------------------------------------------------------------------
